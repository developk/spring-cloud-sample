  ...
  <div class="example-avatar">
    ...
    <div v-show="!edit" class="avatar-upload">
      <div class="text-center p-2">
        <img v-if="hasImageUrl" :src="imageUrl" alt="" class="rounded-circle"/>
        <v-icon v-else color="#eaeaea" size="190">mdi-account-circle</v-icon>
      ...
      <div class="text-center p-2">
        ...
        >
          <v-btn class="mt-1" color="primary" small tile>
            {{ avatarText }}
          </v-btn>
        </file-upload>
      </div>
    ...
    <div v-show="innerFiles.length && edit" class="avatar-edit ">
      <div v-if="innerFiles.length" class="avatar-edit-image">
