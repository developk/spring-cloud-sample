<template>
    <div style="width: 300px !important;">
        <v-dialog v-model="dialogSwitch"
            ...
            <v-toolbar v-if="Boolean(dialogView.title)" :color="dialogView.color" dense>
            ...
            <v-card>
                <v-form ref="form">
                    <v-card-text>
                        <v-container>
                            <v-row>
                                <v-col v-for="(editField,index) in editFields"
                                       :key="index"
                    ...
                    <v-card-actions>
                        <v-spacer/>
                        <v-btn color="secondary" outlined small @click="dialogSwitch=!dialogSwitch">
