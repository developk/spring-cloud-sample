...
import {createDefaultVisitedBar, createMenus, listToTree} from "@/utils/app";
...
router.beforeEach((to, from, next) => {
  ...
  console.info('store.state.user.token: %o', store.state.user.token);
  console.info('SYSTEM_CONFIG.permitUrls: %o', SYSTEM_CONFIG.permitUrls);
  console.info('store.state.user.userOnlineInfo: %o', store.state.user.userOnlineInfo);
